...
**Unarmed.** Make an **Athletics** test, gaining a disadvantage unless you’re being attacked with a [[Items/Weapons/Shardblade|Shardblade]]. You can spend O to disarm your opponent, taking control of their weapon (and wielding it, if you desire).

**Wielding a Weapon.** Make a **Light Weaponry** test or **Heavy Weaponry** test (using the skill corresponding to your weapon). If you’re wielding a **Shardblade** and if your opponent’s weapon is non-Invested, you can spend O to destroy their weapon.
