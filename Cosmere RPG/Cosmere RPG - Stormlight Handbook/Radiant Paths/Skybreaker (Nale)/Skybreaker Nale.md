...
Skybreaker Ideals focus on fighting for justice, upholding codes, and protecting civilization. In the modern era, the Ideals beyond the First typically follow a rigid pattern; see “Swearing Ideals” earlier in this chapter for details on the [[Radiant Paths/Skybreaker/Goals/Speak the First Ideal|First Ideal]]. If you’re bonded to an independent highspren that isn’t part of Nale’s faction (see “Skybreaker History”), you can use the patterns and common phrases below to inspire your own oaths that are less rigid.
