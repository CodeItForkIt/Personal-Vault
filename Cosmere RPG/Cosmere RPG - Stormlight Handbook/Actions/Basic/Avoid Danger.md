...
Make an Agility test to avoid the danger. If doing so in reaction to a test (such as an attack or [[Actions/Basic/Shove|Shove]] action) the DC is equal to that test’s result. Otherwise, the DC is 15. If you fail, you don’t avoid the danger. If you succeed, you avoid the danger to a reasonable degree, as determined by the GM.
