...
- You can spend charges from this fabrial in place of Investiture for the surge.

- If you have no ranks in the corresponding surge skill, consider yourself to have 1 rank for the purpose of determining effects.

- When making a test, you can use the corresponding surge skill (if you have that skill) or your Willpower attribute score (without any ranks in a skill).
