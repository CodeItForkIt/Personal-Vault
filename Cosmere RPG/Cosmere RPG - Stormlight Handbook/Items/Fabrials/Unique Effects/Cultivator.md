...
aliases: ["Cultivator"]
---
![[leaf-glow-maple-green.webp|64]]

*Tier 1 Unique Fabrial Effect*

This fabrial can cause plants to grow rapidly. As 1, spend 1 charge to cause any plants it is touching to grow up to Medium (5-foot) size. These plants can be used to block line of effect, create barriers or cover, or create something to climb.
