...
**Type** Special Weapon; **Weapons Skill** —; **Price** —; **Weight** —;

*Edit this Improvised Weapon statblock to match the most fitting weapon from the Light Weapons table\
\*
