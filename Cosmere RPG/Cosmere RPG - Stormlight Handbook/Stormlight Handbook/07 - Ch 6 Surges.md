...
On Roshar, Stormlight powers incredible Invested abilities known as Surgebinding.

There are ten **surges** in total, each controlling a fundamental force of nature. By wielding Investiture in the form of Stormlight, Surgebinders can perform wondrous feats such as defying gravity, melting the very stone of the earth, or creating illusions out of thin air.

If you wish to wield these powers yourself, you’ll need to become a Radiant (see [[Stormlight Handbook/06 - Ch 5 Radiant Paths|Ch. 5: Radiant Paths]]) by forming a bond with a spren, choosing talents from a Radiant path, and swearing oaths to follow your order’s Ideals.

![[pg208_Jasnah Soulcaster_KIERAN YANNER.webp]]

***“And now,” Jasnah said, voice hard and grim, “the lesson.” She whipped off her glove.*** **- KIERAN YANNER**

## Using Surges

Your Radiant path grants access to the two surges wielded by your order (see [[Stormlight Handbook/17 - Appendix 2 Tables|Radiant Orders]] in [[Stormlight Handbook/06 - Ch 5 Radiant Paths|Ch. 5: Radiant Paths]] ). For example, when an Edgedancer speaks the First Ideal, they gain the Abrasion and Progression surge skills. This chapter presents the basic version of each surge, as well as talent trees to upgrade each surge.
...
- Each surge has an associated attribute (stated in parentheses in that surge’s title). As usual, this attribute determines whether a surge skill is categorized as physical, cognitive, or spiritual.

- To determine your skill modifier for a surge skill, combine your ranks in that skill with the corresponding attribute score.

- When you make a test with a surge, use its surge skill (for example, making an Abrasion test like you would an Agility test).
...
Surges generally follow the same rules as talents (see [[Stormlight Handbook/05 - Ch 4 Heroic Paths|Using Paths and Talents]] in chapter 4 and [[Stormlight Handbook/06 - Ch 5 Radiant Paths|Using Radiant Paths]] in chapter 5). When you’re using a surge, the following additional rules determine how large and powerful your surge is, as well as how long its effects last.
...
When using surges (or their talents), you’ll sometimes roll dice to determine effects like damage dealt or health recovered. When indicated, the size of these **surge dice** scale with your ranks in that surge, as shown on the Surge Scaling table.

### Surge Size

Many surges can only affect characters and objects up to a certain size (see [[Stormlight Handbook/11 - Ch 10 Combat#Size and Space|Size and Space]] in chapter 10), or only affect an area up to that same size (see [[Stormlight Handbook/11 - Ch 10 Combat#Area Effects|Area Effects]] in chapter 10). This **surge size** increases with your ranks in that surge, as shown on the Surge Scaling table.
...
At the start of your turn, but before your infusions expend Investiture (and potentially end), you can use 1 to infuse any amount of additional Investiture in an infusion and maintain its effect. To do so, you must be within the range required to create that infusion.
...
![[pg211_Kaladin and Syl Closeup_DEANDRA SCICLUNA.webp]]
...
- **Talents.** Finally, each entry presents a list of talents you can use to upgrade that surge. You can’t choose these until you speak the First Ideal for that Radiant path. These talents follow the rules in the [[Stormlight Handbook/05 - Ch 4 Heroic Paths|Using Paths and Talents]] section of chapter 4.
...
![[pg213_Lift Abrasion_DEANDRA SCICLUNA.webp]]
...
![[pg215_Squire Adhesion_ARI IBARRA.webp]]
...
*“Seems like it would be good to know, eh?”*
...
![[pg219_stone shaman_AMIRUL HHF.webp]]
...
You can use this surge in countless creative ways, and it’s up to you and your GM to decide how to resolve each situation. For example, you might infuse the ground under your opponent’s feet, causing them to sink them into the earth and become [[Stormlight Handbook/10 - Ch 9 Adventuring#Slowed|Slowed]] by the quagmire. Or you might soften a portion of a stone wall, collapsing it atop them. You might even smear soft stone over a weapon they’re holding, giving it the Cumbersome trait with a value equal to your ranks in Cohesion.
...
![[pg220_DustbringerDivision_JUSTYNA DURA.webp]]
...
![[pg223_Skybreaker Gravitation_PETAR PENEV.webp]]
...
![[pg225_The Fourth Ideal_ANTTI HAKOSAARI.webp]]
...
![[pg228_Stormlight Shardblade_FLORIAN STITZ.webp]]

**An illusory Shardblade is still imposing** **- FLORIAN STITZ**
...
An illusion can move up to your movement rate on your turn in a manner reasonable for that illusion. You can use 0 to have one or more of your illusions perform simple, mindless tasks like walking across the street or shouting a phrase. You can use 1 to task one of your illusions with something that requires your careful attention, such as convincingly conversing with someone.
...
When your illusions begin running out of Stormlight, you can seamlessly maintain them by feeding Investiture from your own supply. You can use 0 to infuse 1 Investiture or more into any illusions of your choice within your spren bond range (spending separate Investiture for each illusion).
...
![[pg231_Stoneward Tension_SVETLANA KOSTINA.webp]]
...
When using Tension to temporarily create a weapon, treat it as an improvised non-special weapon, but remove its Fragile trait (see [[Stormlight Handbook/08 - Ch 7 Items#Improvised Weapons|Improvised Weapons]] in chapter 7).
...
![[pg234_Soulcasting Concept_AUSTIN HARTELL.webp]]

**AUSTIN HARTELL**

*"Kings rule and war with Shards— but their armies subsist through Soulcasters."*

### Transformation on Others

While you can’t Soulcast living characters with the basic Transformation surge, you can creatively use your abilities to be useful and dangerous in combat. You might create obscuring fog out of thin air, giving attackers a disadvantage. You could create cover to shield behind. You might even turn the ground beneath your opponent’s feet into liquid, causing them to fall [[Stormlight Handbook/10 - Ch 9 Adventuring#Prone|Prone]].
...
> [!tip] Peering Into Shadesmar
> The surge of Transformation grants a limited ability to look into the Cognitive Realm. To do so, you can spend 2 Investiture and Use a Skill to make a Transformation test. On a success, you can use one effect from the Transportation surge (see [[Stormlight Handbook/07 - Ch 6 Surges|Transportation (Intellect)]]) to perceive 10 feet around you in the corresponding location in Shadesmar.
...
*"The entire building shattered into thousands upon thousands of small glass spheres, like beads.*

*Jasnah screamed as she fell backward through a dark sky. She was no longer in the palace; she was somewhere else— another land, another time, another … something.* "\
